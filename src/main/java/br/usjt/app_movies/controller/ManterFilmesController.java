package br.usjt.app_movies.controller;
...
import br.usjt.app_movies.model.service.FilmeService;
import br.usjt.app_movies.model.service.GeneroService;
...
public class ManterFilmesController {
	...
	@RequestMapping("/listar_populares")
	public String baixarFilmesMaisPopulares(HttpSession session) {
		try {
			List<Filme> lista = fService.baixarFilmesMaisPopulares();
			session.setAttribute("lista", lista);
			return "ListarFilmes";
		} catch (IOException e) {
			e.printStackTrace();
	...
	@RequestMapping("/listar_lancamentos")
	public String baixarFilmesLancamentos(HttpSession session) {
		try {
			List<Filme> lista = fService.baixarFilmesLancamentos();
			session.setAttribute("lista", lista);
			return "ListarFilmes";
		} catch (IOException e) {
			e.printStackTrace();
